...
# ============================================================
# Test: SENTINEL-XXX ID assignment is sequential
# ============================================================
test_sequential_ids() {
    setup_test_dir
    ...
    assert_json_value "$output" "findings.0.id" "SENTINEL-001" "ids: first finding is SENTINEL-001"
    assert_json_value "$output" "findings.1.id" "SENTINEL-002" "ids: second finding is SENTINEL-002"
    assert_json_value "$output" "findings.2.id" "SENTINEL-003" "ids: third finding is SENTINEL-003"
...
test_single_tool() {
    ...
    assert_json_value "$output" "findings.0.id" "SENTINEL-001" "single_tool: first ID is SENTINEL-001"
