...
# Generates a sentinels.io-compatible badge JSON from a Sentinel scan result.
# The badge file can be committed to the repo and referenced via sentinels.io
...
#
# Outputs: sentinel-badge.json (sentinels.io endpoint schema)
...
# Generate sentinels.io endpoint badge JSON
# See: https://sentinels.io/badges/endpoint-badge
jq -n \
    --argjson schema 1 \
    --arg label "Sentinel Score" \
